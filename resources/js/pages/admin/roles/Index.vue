...
async function destroyRole(id: number) {
    const result = await confirmDelete('Are you sure you want to delete this role?');
...
<template>
    ...
    >
        <div class="flex items-center justify-between">
            ...
            <Button v-if="can('create-role')" as-child>
