...
<template>
    <Head :title="`users.edit_title ${user.name}`" />
        <div
            class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4"
        >
            <h1 class="text-xl font-semibold">{{ 'users.edit_title' }}</h1>
...
<!--                </div>-->
                ...
                <div class="grid gap-2">
                    <Label for="password">{{ 'users.new_password_label' }}</Label>
                    <Input
                        id="password"
                        name="password"
                        type="password"
                        :placeholder="'users.new_password_placeholder'"
                    />
                ...
                <div class="grid gap-2">
                    ...
                    >{{ 'users.confirm_new_password_label' }}</Label
                    >
                    <Input
